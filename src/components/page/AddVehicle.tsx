...
const AddVehicle: React.FC<AddVehicleProps> = ({ parkingLotObject }) => {
  ...
  return (
    <section className="bg-white shadow-lg rounded-lg p-8 w-full max-w-7xl mx-auto mt-8">
      ...
      <div className="flex justify-center space-x-6">
        ...
        onClick={() => {
          var bus = new Bus();
          parkingLotObject.handleParkVehicle(bus);
          // parkingLotObject.parkVehicle(bus);
        }
        }>
          Add a Bus
        </button>
        ...
        {/* <button className="bg-blue-500 text-white py-3 px-8 rounded-lg hover:bg-blue-600 transform hover:scale-105 transition duration-300 shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-300"
        onClick={() => {
          parkingLotObject.parkVehicle(new Car());
        }
        }>
        Add a Car
        </button>
        ...
        <button className="bg-blue-500 text-white py-3 px-8 rounded-lg hover:bg-blue-600 transform hover:scale-105 transition duration-300 shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-300"
        onClick={() => {
          parkingLotObject.parkVehicle(new Motorcycle());
        }
        }>
        Add a Motorcycle
        </button> */}
